...
export function VariantPicker({ context, userProfile, onSelectVariant, onClose, isLoading }: any) {
    ...
    return (
      <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
        <div className="bg-surface-container/95 backdrop-blur-md border border-outline-variant rounded-2xl w-full max-w-md p-5 space-y-4">
          ...
          <p className="font-label-md text-[10px] font-semibold uppercase tracking-widest text-on-surface-variant mt-1">Prueba con otra razon o ajusta filtros</p>
        </div>
      </div>
    )
  }
